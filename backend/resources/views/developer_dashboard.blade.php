...
<body class="h-full flex flex-col font-sans selection:bg-blue-600 selection:text-white">
    ...
    @if(!$isAuthenticated)
        <!-- LOGIN INTERFACE -->
        <div class="flex-1 flex flex-col justify-center items-center px-6 py-12 relative overflow-hidden bg-brand-deep">
            <!-- Background Glow Elements -->
            <div class="absolute w-[500px] h-[500px] rounded-full bg-blue-900/10 blur-[120px] -top-40 -left-40"></div>
            <div class="absolute w-[500px] h-[500px] rounded-full bg-purple-900/10 blur-[120px] -bottom-40 -right-40"></div>

            <div class="w-full max-w-md space-y-8 relative z-10">
                <div class="text-center space-y-2">
                    <div class="inline-flex w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 items-center justify-center shadow-lg shadow-blue-500/25 mb-4">
                        <span class="text-3xl font-extrabold text-white">S</span>
                    </div>
                    <h2 class="text-3xl font-extrabold text-white tracking-tight">Sankara DevHub</h2>
                    <p class="text-sm text-gray-400">Developer Dashboard Authentication Gate</p>
                </div>
                ...
                <div class="glass-panel p-8 rounded-2xl space-y-6">
                    <form action="/admin/login" method="POST" class="space-y-4">
                        @csrf
                        <div>
                            <label for="password" class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Developer Key / Password</label>
                            <input type="password" name="password" id="password" required placeholder="••••••••••••••••" 
                                class="w-full px-4 py-3 rounded-xl bg-gray-900/60 border border-brand-border text-white text-sm font-medium focus:outline-none focus:border-blue-500 transition-colors placeholder:text-gray-600">
                        </div>
                        ...
                        <button type="submit" class="glow-button w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-bold tracking-wide shadow-lg shadow-blue-500/20 mt-6">
                            Authenticate & Enter
                        </button>
                    </form>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <form action="/admin/logout" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="px-4 py-2 border border-brand-danger/30 text-brand-danger hover:bg-brand-danger/10 rounded-lg text-sm font-semibold">
                            Exit
                        </button>
                    </form>
                </div>
