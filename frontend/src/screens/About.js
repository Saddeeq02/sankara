...
export function renderAboutScreen() {
  ...
  heroSec.innerHTML = `
    ...
    <div style="position: absolute; top: -50%; left: -20%; width: 80%; height: 150%; background: radial-gradient(circle, rgba(5,150,105,0.08) 0%, transparent 60%); pointer-events: none;"></div>
    <div style="position: absolute; bottom: -50%; right: -20%; width: 80%; height: 150%; background: radial-gradient(circle, rgba(5,150,105,0.05) 0%, transparent 60%); pointer-events: none;"></div>
    
    <div class="container" style="position: relative; z-index: 1;">
      <div style="max-width: 800px; margin: 0 auto; text-align: center; margin-bottom: 70px;">
        <span class="reveal" style="font-size: 0.85rem; font-weight: 800; color: #34d399; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 20px; display: inline-block; background: rgba(52, 211, 153, 0.1); padding: 8px 18px; border-radius: 100px; border: 1px solid rgba(52, 211, 153, 0.25);">
        ...
        <h1 class="reveal" style="font-size: clamp(2.5rem, 6vw, 4.8rem); font-weight: 900; line-height: 1.1; letter-spacing: -2px; margin-bottom: 25px;">
          Powering Nigeria's <br><span style="color: #34d399;">Modern Farming</span>
        </h1>
      ...
      <div class="reveal about-stats-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px; margin-top: 60px; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 60px;">
        <div style="text-align: center;">
          <h3 style="font-size: 3rem; font-weight: 900; color: #34d399; margin-bottom: 8px; line-height: 1;">40+</h3>
        ...
        <div style="text-align: center;">
          <h3 style="font-size: 3rem; font-weight: 900; color: #34d399; margin-bottom: 8px; line-height: 1;">1200+</h3>
        ...
        <div style="text-align: center;">
          <h3 style="font-size: 3rem; font-weight: 900; color: #34d399; margin-bottom: 8px; line-height: 1;">5000+</h3>
          <span style="color: #94a3b8; font-weight: 700; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 1px;">Farmers Served</span>
        </div>
        <div style="text-align: center;">
          <h3 style="font-size: 3rem; font-weight: 900; color: #34d399; margin-bottom: 8px; line-height: 1;">36</h3>
  ...
  legacySec.innerHTML = `
    <div class="container" style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 80px; align-items: center;">
      ...
      <div class="reveal" style="position: relative; background: linear-gradient(135deg, rgba(5,150,105,0.05) 0%, rgba(5,150,105,0.15) 100%); border-radius: 32px; padding: 60px; border: 1px solid rgba(5,150,105,0.1);">
        <div style="font-size: 15rem; font-weight: 900; color: rgba(5,150,105,0.03); position: absolute; top: -50px; right: -20px; pointer-events: none; user-select: none;">1986</div>
      ...
      <div class="reveal" style="animation-delay: 0.2s;">
        <span style="font-size: 0.85rem; font-weight: 800; color: #059669; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 12px; display: block;">Company Story</span>
  ...
  mvvSec.innerHTML = `
    <div class="container" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
      <!-- Mission Card -->
      <div class="reveal premium-glass-card" style="padding: 45px; border-radius: 28px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        <div style="display: inline-flex; align-items: center; justify-content: center; width: 56px; height: 56px; background: rgba(5, 150, 105, 0.1); color: #059669; border-radius: 14px; margin-bottom: 25px;">
  ...
  chooseSec.innerHTML = `
    <div class="container">
      <div style="text-align: center; margin-bottom: 70px;">
        <span class="reveal" style="font-size: 0.85rem; font-weight: 800; color: #059669; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 12px; display: block;">Why Choose Us</span>
      ...
      <div class="about-why-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px;">
        ...
        <div class="reveal premium-glass-card" style="padding: 35px; border-radius: 24px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
          <div style="display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; background: rgba(5, 150, 105, 0.1); color: #059669; border-radius: 12px; margin-bottom: 22px;">
  ...
  brandSec.innerHTML = `
    <div class="container">
      <div style="text-align: center; margin-bottom: 70px;">
        <span class="reveal" style="font-size: 0.85rem; font-weight: 800; color: #059669; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 12px; display: block;">Strategic Partnerships</span>
      ...
      <div class="reveal brand-partnership-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin-bottom: 80px;">
        ...
        <!-- Card 1 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <!-- Card 2 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s; animation-delay: 0.05s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <!-- Card 3 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s; animation-delay: 0.1s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <!-- Card 4 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s; animation-delay: 0.15s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <!-- Card 5 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s; animation-delay: 0.2s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <!-- Card 6 -->
        <div class="premium-glass-card" style="padding: 30px; border-radius: 20px; background: #ffffff; border: 1px solid #e2e8f0; transition: all 0.3s; animation-delay: 0.25s;" onmouseover="this.style.transform='translateY(-5px)'; this.style.borderColor='#059669';" onmouseout="this.style.transform='none'; this.style.borderColor='#e2e8f0';">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 40px;" class="about-why-grid">
          <div>
            <h4 style="font-size: 1.15rem; font-weight: 850; color: #0f172a; margin-bottom: 10px; display: flex; align-items: center; gap: 10px;">
              <span style="color: #059669;">✔</span> Proven Track Record
            </h4>
          ...
          <div>
            <h4 style="font-size: 1.15rem; font-weight: 850; color: #0f172a; margin-bottom: 10px; display: flex; align-items: center; gap: 10px;">
              <span style="color: #059669;">✔</span> Extensive Network
            </h4>
            <p style="color: #475569; font-size: 0.98rem; line-height: 1.6; margin: 0; padding-left: 24px;">
          ...
          <div>
            <h4 style="font-size: 1.15rem; font-weight: 850; color: #0f172a; margin-bottom: 10px; display: flex; align-items: center; gap: 10px;">
              <span style="color: #059669;">✔</span> Technical Expertise
            </h4>
            <p style="color: #475569; font-size: 0.98rem; line-height: 1.6; margin: 0; padding-left: 24px;">
          ...
          <div>
            <h4 style="font-size: 1.15rem; font-weight: 850; color: #0f172a; margin-bottom: 10px; display: flex; align-items: center; gap: 10px;">
              <span style="color: #059669;">✔</span> Market Leadership
            </h4>
            <p style="color: #475569; font-size: 0.98rem; line-height: 1.6; margin: 0; padding-left: 24px;">
      ...
      <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border-radius: 32px; padding: 60px 80px; display: grid; grid-template-columns: 1.2fr 1fr; gap: 60px; align-items: center; color: #ffffff; margin-bottom: 80px;" class="reveal about-panel-grid">
        ...
        <div style="display: flex; gap: 40px; justify-content: flex-end;" class="about-panel-stats">
          <div style="text-align: center;">
            <div style="font-size: 3rem; font-weight: 900; color: #34d399; line-height: 1;">15+</div>
          ...
          <div style="text-align: center;">
            <div style="font-size: 3rem; font-weight: 900; color: #34d399; line-height: 1;">100%</div>
      ...
      <div class="reveal">
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px;" class="about-why-grid">
          ...
          <div style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; padding: 30px; text-align: center;">
            <div style="font-size: 1.6rem; font-weight: 900; color: #059669; margin-bottom: 10px;">8+</div>
          ...
          <!-- Cat 2 -->
          <div style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; padding: 30px; text-align: center;">
            <div style="font-size: 1.6rem; font-weight: 900; color: #059669; margin-bottom: 10px;">12+</div>
          ...
          <!-- Cat 3 -->
          <div style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; padding: 30px; text-align: center;">
            <div style="font-size: 1.6rem; font-weight: 900; color: #059669; margin-bottom: 10px;">5+</div>
          ...
          <!-- Cat 4 -->
          <div style="background: #ffffff; border-radius: 20px; border: 1px solid #e2e8f0; padding: 30px; text-align: center;">
            <div style="font-size: 1.6rem; font-weight: 900; color: #059669; margin-bottom: 10px;">20+</div>
  ...
  // Inject responsive stylesheet for About page
